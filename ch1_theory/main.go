...
// // variable expression : if 조건에서 변수 생성해서 쓰기
// // if, else
// func canIDrink(age int) bool {
// 	// // 기본 형태
// 	// if age < 18 {
...
// // go랭에는 for만 존재하고 파생상품 map, for in 들은 전혀 없다.
// // 그래도 순회는 있음 -> range
// // 기본 for문
...
// // defer -> js의 on이라고 보면 편함. 함수코드가 return까지 실행되고 나서 끝나느게 아니라,
...
// // go랭 func returnx 관련한 naked return.
// func lenAndUpper(name string) (length int, uppercase string) {
